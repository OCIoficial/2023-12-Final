...
\begin{scoreDescription}
  \subtask{20} Se probarán varios casos donde $n = 2$, es decir, hay exactamente $2$ participantes.
  \subtask{40} Se probarán varios casos donde $n \leq 100$.
  \subtask{40} Se probarán varios casos sin restricciones adicionales.
