...
/**
 * Check whether this grid contains a single side-wise connected component. It assumes the grid contains ones and zeros only and that the edges of the grid can only contain zeros.
 *
...
int main() {
  ...
  inf.readEoln();
  ensuref(n * m <= 200'000, "%d×%d is greater than 200,000.")
